...
function upload(selector) {
  ...
  var onLoad = (_options$onLoad = options.onLoad) !== null && _options$onLoad !== void 0 ? _options$onLoad : noop;
  var files = [];
  ...
  var trigerInput = function trigerInput() {
    return input.click();
  };

  var changeViwe = function changeViwe(event) {
  ...
  var removeImg = function removeImg(event) {
    ...
    var bloc = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest('.preview-image');
  ...
  var cliarPreview = function cliarPreview(el) {
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.browser.esm.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
(0, _upload.upload)('file', {
  ...
  onLoad: function onLoad(files, blocks) {
    files.forEach(function (file, index) {
      var ref = storage.ref("imeges/".concat(file.name));
      var task = ref.put(file);
      task.on('state_changed', function (snapshot) {
        var percentage = (snapshot.bytesTransferred / snapshot.totalBytes * 100).toFixed(0) + '%';
        var block = blocks[index].querySelector('.preview-info-progres');
